...
public interface FiliereRepository extends JpaRepository<Filiere, Long> {
    ...
    /**
     * ✅ AJOUTÉ — Trouve toutes les filières d'un institut.
     * Chemin : filiere → ecole → institut
     * Utilisé par MigrationController (liste de sélection) et MigrationService.
     */
    @Query("SELECT f FROM Filiere f WHERE f.ecole.institut.id = :institutId")
    List<Filiere> findByInstitutId(@Param("institutId") Long institutId);
}